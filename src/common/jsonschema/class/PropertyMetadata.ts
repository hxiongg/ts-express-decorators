...
export class PropertyMetadata extends Storable implements IPropertyOptions {
   ...
   * @type {Array}
   */
  @NotEnumerable() private _allowedRequiredValues: any[] = [];

  @NotEnumerable() private _ignoreProperty: boolean = false;

  constructor(target: any, propertyKey: any) {
    super(target, propertyKey);
    this.store.set("schema", JsonSchemesRegistry.createFromEntity(this));
  }
